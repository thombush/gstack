...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, pi, kilo];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, pi, kilo };
